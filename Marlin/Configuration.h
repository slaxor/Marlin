...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { XY_STEPS, XY_STEPS, Z_STEPS, WADE_E_STEPS } // { 128, 128, 533.33, 500 }
...
#define DEFAULT_MAX_FEEDRATE          { 20 * XY_STEPS, 20 * XY_STEPS, 20 * Z_STEPS, 2 * WADE_E_STEPS }
...
#define DEFAULT_MAX_ACCELERATION      { 100 * XY_STEPS, 100 * XY_STEPS, 100 * Z_STEPS, 100 * WADE_E_STEPS }
